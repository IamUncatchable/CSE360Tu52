...
private void generateNotesScreen() {
		...
		right.getChildren().add(1,historyBox);
		right.getChildren().add(2,ready);
		...
		TextField nurseNotes = new TextField(currentVisit.getNurseNotes());
		...
		Label drNotesLabel = new Label("Doctors's Notes");
		drNotesLabel.getStyleClass().add("defaultText");
		drNotes = new TextField();
		drNotes.getStyleClass().add("TextBox2");
		drNotes.setMaxHeight(200);
		drNotes.setMinHeight(200);
		drNotes.setAlignment(Pos.TOP_LEFT);
		VBox drNotesBox= new VBox();
		drNotesBox.getChildren().add(0,drNotesLabel);
		drNotesBox.getChildren().add(1,drNotes);
		
		VBox center = new VBox();
		center.setTranslateX(-50);
		center.setMaxWidth(600);
		center.getChildren().add(0,nurseNotesBox);
		center.getChildren().add(1,drNotesBox);
	...
	private void doPatientFinished() {
		currentVisit.setFinished(true);
		currentVisit.setDRNotes(drNotes.getText());
